...
<head>
    ...
    <style>
        body {
            background-image:url('https://wallpaperscraft.com/image/battlefield_4_game_ea_digital_illusions_ce_93159_1920x1080.jpg');
        }
        .login-sidebar:after {
            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        @if($admin_logo_img == '')
                        <img class="img-responsive pull-left logo hidden-xs animated fadeIn" src="/img/logo_dark.png" alt="Logo Icon">
                        @else
                        <img class="img-responsive pull-left logo hidden-xs animated fadeIn" src="{{ Voyager::image($admin_logo_img) }}" alt="Logo Icon">
                        @endif
                        <div class="copy animated fadeIn">
                            <h1>{{ Voyager::setting('admin_title', 'GamersHUB') }}</h1>
                            <p>{{ Voyager::setting('admin_description', 'Panel de administración') }}</p>
                        </div>
        ...
        <div class="col-xs-12 col-sm-4 col-md-3 login-sidebar animated fadeInRightBig">
            ...
            <div class="login-container animated fadeInRightBig">
                ...
                <button type="submit" class="btn btn-block login-button">
                    <span class="signingin hidden"><span class="glyphicon glyphicon-refresh"></span> Entrando...</span>
