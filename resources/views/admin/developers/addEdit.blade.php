...
@section('contenido')
    <section class="bg-primary">
        <div class="container">
            <h3 class="color-white font-weight-300">@lang('admin.addDeveloper.title') | @lang('admin.editDeveloper.title')</h3>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">@lang('general.developers.title')</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="name">@lang('admin.addEditDeveloper.name.label')</label>
                                    <input type="text" class="form-control" placeholder="@lang('admin.addEditDeveloper.name.input')" name="name" id="name">
                                </div>
                            </div>
                        </div>
                    </div>
