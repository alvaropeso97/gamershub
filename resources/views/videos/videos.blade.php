...
@section('titulo', 'Todos los vídeos - GamersHUB')
@php $cons =  \App\Article::whereRaw('tipo = "vid"')->orderBy('id','desc')->paginate(16); @endphp
@section('contenido')
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="card card-video">
                            ...
                            <div class="caption">
                                ...
                                <ul>
                                    <li><i class="fa fa-clock-o"></i> {{\App\Http\Controllers\ArticlesController::traducirFecha($video->fecha)}}</li>
