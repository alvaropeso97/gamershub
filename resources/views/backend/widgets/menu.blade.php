    ...
    <div class="subnavbar-inner">
        <div class="container">
            <ul class="mainnav">
                ...
                <li><a href="/backend/usuarios"><i class="icon-user"></i><span>Usuarios</span></a></li>
                ...
                <li @yield('configuracion')><a href="/backend/configuracion"><i class="icon-cog"></i><span>Configuración</span></a></li>
        </div>
    </div>
</div>