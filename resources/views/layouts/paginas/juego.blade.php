        ...
        <div class="container">
            ...
            <div class="row sidebar">
                <div class="col-md-8 padding-right-20 leftside">
                    <!-- Artículos recientes -->
                    @include('layouts.widgets.juego.articulos_recientes')
                </div>
                <div class="col-md-4 padding-left-20 rightside">
                    <!-- Info Juego -->
                    @include('layouts.widgets.juego.info_juego')

                    <!-- Noticias/Comentarios/Foros -->
                    @include('layouts.widgets.juego.noticias_comentarios_foros')

                    <!-- Vídeos relacionados -->
                    @include('layouts.widgets.juego.videos_relacionados')
                </div>
            </div>
        </div>
    </section>
