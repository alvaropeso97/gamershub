    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title">
                        <h4><i class="fa fa-gamepad"></i> Editar juego</h4>
                    </div>
                    <form method="post" action="/panel/juegos/editar-juego/{{$id->id}}/modificar" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <textarea class="form-control bg-white" name="descripcion">{{$id->descripcion}}</textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row margin-top-30">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <input type="text" name="desarrollador" value="{{$id->desarrollador}}" class="form-control">
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <label>Distribuidor</label>
                                <input type="text" name="distribuidor" value="{{$id->distribuidor}}" class="form-control">
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <label>Jugadores</label>
                                <input type="text" name="jugadores" value="{{$id->jugadores}}" class="form-control">
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <label>Duración</label>
                                <input type="text" name="duracion" value="{{$id->duracion}}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row margin-top-30">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <input type="text" name="dispo_en" value="{{$id->dispo_en}}" class="form-control">
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <label>Idioma/s</label>
                                <input type="text" name="idioma" value="{{$id->idioma}}" class="form-control">
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <label>Fecha de lanzamiento</label>
                                <input type="text" name="fecha_lanzamiento" value="{{$id->fecha_lanzamiento}}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div style="text-align: right;" class="row margin-top-30">
                            ...
                            <button type="submit" class="btn btn-success btn-icon-right">Editar juego <i class="fa fa-check-square-o"></i></button>
                        </div>
                    </form>
                </div>
            </div>
