                ...
                <div class="col-md-9 col-sm-8">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade active in" id="info_gral">
                            @php $UsrInfo = \App\Http\Controllers\UsersController::devolverInfo($id->id) @endphp
                                ...
                                <div class="container">
                                    ...
                                    <div class="row margin-top-20">
                                        <div class="col-lg-8">
                                            ...
                                            @php $plataformas_usuario = \App\Http\Controllers\UsersController::devolverPlataformasUsuario($id->id) @endphp
                                            <select id="categorias" name="plataformas[]" multiple class="form-control" style="height: 90px; padding: 0px;">
                                                @foreach(\App\Category::where('esplataforma','1')->get() as $plataforma)
                                        ...
                                        <div class="row margin-top-20">
                                            <div class="col-lg-8">
                                                ...
                                                <select name="genero_preferido" class="form-control">
                                                    ...
                                                    @foreach(\App\Genre::all() as $genero)
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group input-icon-left">
                                                ...
                                                <select name="pais" class="form-control">
                                                    ...
                                                    @foreach(\App\Country::all() as $pais)
                        ...
                        <div class="tab-pane fade" id="privacidad">
                            <div class="container">
                                @php $privacidad = \App\Http\Controllers\UsersPrivacyController::devolverOpcionesPrivacidad($id->id) @endphp
